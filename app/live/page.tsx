...
export default function LiveAttendance(){
 ...
 async function punch(employee:Employee,action:string){
   ...
   const today=punches.filter(p=>p.employee_id===employee.id&&p.punched_at.slice(0,10)===selectedDate);
   const open=today.some(p=>p.action==="Shift In")&&!today.some(p=>p.action==="Shift Out");
